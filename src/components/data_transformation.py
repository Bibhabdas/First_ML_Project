...
class DataTransformation:
    def __init__(self):
        self.data_transformation_config = DataTransformationConfig()  # Corrected the typo
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(f"APllying preprocessing object on training dataframe and testing dataframe")
